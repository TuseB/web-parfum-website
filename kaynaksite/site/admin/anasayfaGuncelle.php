...
$guncelleSorgu=$baglanti->prepare("update anasayfa set ustBaslik=:ustBaslik, altBaslik=:altBaslik, linkMetin=:linkMetin, link=:link, tanimlama=:tanimlama, keyy=:keyy where id=:id");
$guncelle=$guncelleSorgu->execute([
    ...
    if($guncelle){
        ...
        echo "<script> Swal.fire( {title:'Başarılı', text:'Başarıyla Güncellendi', icon:'success', confirmButtonText:'Kapat' }).then((value)=>{
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="" method="post">
                                    ...
                                    <div class="form-group">
                                        <label>Anahtar</label>
                                        <input type="text" name="keyy" required class="form-control" value="<?=$sonuc["keyy"]?>">
                                    </div>
                                    <div class="form-group">
