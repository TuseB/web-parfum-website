            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger <?php if($sayfa=="Portfolyo") echo "active" ?>" href="portfolyo">Ürünlerimiz</a></li>
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger <?php if($sayfa=="Giriş") echo "active" ?>" href="admin/login">Giriş</a></li>
                    </ul>
                </div>
            </div>
        </nav>